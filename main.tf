...
# key is stored in a Kubernetes Secret that ArgoCD discovers automatically.
#
...
# ============================================================
# Bootstrap Helm chart — installs the AppProject + ApplicationSet
# ============================================================
#
# The homelab-bootstrap chart lives in the mono repo at apps/.
# Terraform clones it locally and installs it, giving ArgoCD its
# entry point. From here ArgoCD takes over and deploys everything else.
